...
if(!isset($error)){
    ...
    $resultresetpass= mysqli_query($con, "UPDATE users SET password='$password' WHERE email='$emailtok'"); 
    if($resultresetpass) 
    { 
          ...
          $resultdel = mysqli_query($con, "DELETE FROM pass_reset WHERE token='$token'");
          $hide=1;
    }
} 
    }
