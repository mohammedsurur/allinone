...
<?php  
   $query="select * from directorates_account where position='Deputy Dean of Technology Development and Incubation' AND account_status='Active' ";  
                    ...
                    <div class="col-sm-6">
                        <div class="teacher-info">
                            <ul class="list-unstyled">
                                <li>
                                    <h3>Name :</h3>
                                    <span><?php echo ucwords($row["first_name"]." ".$row["middle_name"]);  ?></span>
                                </li>
                                <li>

                                    <h3>Position :</h3>
                                    <span><?php echo ucwords($row["position"]);  ?></span>
                                </li>
                                <li>
                                    <h3>Email :</h3>
                                        ...
                                        $query1="select * from service where catagory='$position'";
                                         ...
                                         while ($row1=mysqli_fetch_array($run1)) {
                                            ...
                                            $service_id = $row1["service_id"];
                                                 ?>
                                            <li>
                                                <?php echo ">>- <a  href=service_details.php?service_id=".$row1['service_id'].">".ucwords($row1['service'])." </a> ";  ?>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                 <div class="single_item">
                    <div class="item_wrapper">
                        ...
                        <h3><?php echo "  <a  href=technology_details.php?tech_id=".$row['tech_id'].">".ucwords($row['technology_name'])." </a> ";  ?></h3> 
                    </div>
                    <div class="blog_title">
                        <ul class="post_bloger">
                            <li><i class="fas fa-user"></i><?php echo ucwords($row['developer_name'] ) ?>.</li> 
                            <li><i class="flaticon-clock-circular-outline"></i><?php echo $row['mani_date']  ?></li>
